...
optimized_hyperparams=min_sep_IBO_random_walk_optimization(training_comps, training_quants, init_lambda=1e-6, use_Gauss=use_Gauss, max_stagnating_iterations=16, num_kfolds=32,
