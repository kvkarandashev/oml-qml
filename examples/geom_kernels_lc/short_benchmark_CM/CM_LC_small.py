...
from learning_curve_building import KR_model, best_model_params, make_learning_curves_with_stdev, print_means_errs_to_log_file,\
                    ...
                    CM_representation, Gaussian_kernel_function
...
for sigma in geom_progression(1.0, 2.0, 10):
    cur_model=KR_model()
    cur_model.representation=CM_representation()
    cur_model.kernel_function=Gaussian_kernel_function(sigma, lambda_val=lambda_val)
