...
optimized_hyperparams=min_sep_IBO_random_walk_optimization(training_comps, training_quants, init_lambda=1e-6, use_Gauss=use_Gauss,
                                    max_stagnating_iterations=8, num_kfolds=128, hyperparam_red_type="ang_mom_classified",
                                    randomized_iterator_kwargs={"keep_init_lambda" : keep_init_lambda, "default_step_magnitude" : 0.25},
                                    iter_dump_name_add="test_min", rep_params=oml_representation_parameters)
