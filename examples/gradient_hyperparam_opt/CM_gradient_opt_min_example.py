...
optimized_hyperparams=min_sep_IBO_random_walk_optimization(training_comps, training_quants, init_lambda=1e-6, init_param_guess=np.array([1.0, 100.0]), max_stagnating_iterations=8,
                                    hyperparam_red_type="default", randomized_iterator_kwargs={"default_step_magnitude" : 0.25}, iter_dump_name_add="test_min_CM",
                                    additional_BFGS_iters=128, iter_dump_name_add_BFGS="test_min_BFGS", sym_kernel_func=gaussian_sym_kernel_conv_wders, kernel_input_converter=CM_kernel_input)
