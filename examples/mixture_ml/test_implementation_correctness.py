...
from qml.kernels_wders import gaussian_pos_sum_restr_kernel
import random
import numpy as np
...
mat0=gaussian_pos_sum_restr_kernel(A, B, sigmas)

print("mat:", mat0)

fd_step=0.00001

mat_analytic_der=gaussian_pos_sum_restr_kernel(A, B, sigmas, with_ders=True)
...
for der_id in range(dimf):
    ...
    for fd in [-1, 1]:
        ...
        mat_fd+=fd*gaussian_pos_sum_restr_kernel(A, B, cur_sigmas)
    mat_fd/=2*fd_step
#    print("mat_fd", mat_fd)
