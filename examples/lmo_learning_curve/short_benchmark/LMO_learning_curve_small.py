...
current_representation=OML_Slater_pair_rep(max_angular_momentum=1, use_Fortran=True, ibo_atom_rho_comp=0.95, calc_type="HF", second_calc_type="UHF", second_orb_type="IBO_HOMO_removed")
