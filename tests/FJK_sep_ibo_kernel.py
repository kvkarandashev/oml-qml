...
kernel_params=qml.oml_kernels.GMO_kernel_params(width_params=width_params, final_sigma=0.5, use_Fortran=True, normalize_lb_kernel=True, use_Gaussian_kernel=True, pair_reps=False)
