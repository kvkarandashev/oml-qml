...
my_representation=OML_Slater_pair_rep(max_angular_momentum=1, use_Fortran=True, ibo_atom_rho_comp=0.95, second_calc_type="UHF", second_orb_type="IBO_LUMO_added")
