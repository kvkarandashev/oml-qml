...
my_representation=my_representation=OML_Slater_pair_rep(max_angular_momentum=1, use_Fortran=True, ibo_atom_rho_comp=0.95, second_spin=2, second_calc_type="UHF")
...
kernel_params=qml.oml_kernels.GMO_kernel_params(width_params=width_params, final_sigma=0.5, use_Fortran=True, normalize_lb_kernel=True, use_Gaussian_kernel=True, pair_reps=True)
