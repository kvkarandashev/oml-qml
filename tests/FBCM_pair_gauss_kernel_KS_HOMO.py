...
my_representation=OML_Slater_pair_rep(max_angular_momentum=1, use_Fortran=True, ibo_atom_rho_comp=0.95, first_calc_type="KS", second_calc_type="KS", second_orb_type="IBO_HOMO_removed",
                                            fbcm_pseudo_orbs=True, fock_based_coup_mat=True, num_prop_times=2, prop_delta_t=0.5)
...
kernel_params=qml.oml_kernels.GMO_kernel_params(width_params=width_params, use_Fortran=True, normalize_lb_kernel=True, use_Gaussian_kernel=True)
