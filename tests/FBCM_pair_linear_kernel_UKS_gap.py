...
my_representation=OML_Slater_pair_rep(max_angular_momentum=1, use_Fortran=True, ibo_atom_rho_comp=0.95, first_calc_type="KS", second_calc_type="UKS", second_orb_type="IBO_first_excitation",
                                            fock_based_coup_mat=True, num_fbcm_times=2, fbcm_delta_t=0.5)
